...
class Config:
    ...
    # Flask settings
    SECRET_KEY = os.environ.get('SECRET_KEY') or 'omr-flask-secret-key-change-in-production'
    ...
    # YOLO Model settings
    MODEL_PATH = os.environ.get('MODEL_PATH') or str(BASE_DIR.parent / 'backend' / 'yolov8n-cls.pt')
